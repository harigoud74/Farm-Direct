      ...
      <div className="bg-white w-full max-w-md h-full shadow-2xl flex flex-col justify-between animate-in slide-in-from-right duration-300">
        ...
        <div className="p-4 border-b border-stone-200 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h2 className="text-base font-bold text-stone-900">Your Fresh Farm Cart</h2>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {cartItems.length === 0 ? (
            <div className="text-center py-16 space-y-3">
              ...
              <h3 className="text-sm font-bold text-stone-900">Your cart is empty</h3>
              <p className="text-xs text-stone-500 max-w-xs mx-auto">
                Explore organic tomatoes, crisp onions, and exotic produce directly harvested by verified farmers.
              </p>
            </div>
          ) : (
            <>
              ...
              <div className="bg-emerald-50 border border-emerald-200/80 rounded-2xl p-3 text-xs space-y-1">
                <div className="flex items-center justify-between font-bold text-emerald-950">
                  ...
                  <span className="text-emerald-700 font-extrabold">
                    Save {formatINR(totalBuyerSavings)}
                  </span>
                </div>
                <p className="text-[11px] text-emerald-800">
                  Farmers receive <strong>{formatINR(totalProductAmount)}</strong> directly (an extra {formatINR(totalFarmerBonus)} vs traditional commission agents).
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-stone-500 truncate">
                        Farm: {item.product.farmName} ({item.product.farmerLocation.district})
                      </p>
